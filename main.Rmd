...
# Fix duplicate label names
  data_dictionary[data_dictionary$field_name %in% names(report_data), "field_label"] <- vctrs::vec_as_names(data_dictionary[data_dictionary$field_name %in% names(report_data), "field_label"], repair = "unique", quiet = TRUE)
